			       ...
			       if (substr($k,0,2)=="cb")
			          {
				         ...
				         echo 'Do you want to delete '.$idc.'?';
				         echo'<input type="submit" name="yesdel" value="Yes" class="btn btn btn-warning">';
				         echo'<input type="submit" name="nodel" value="No" class="btn btn btn-primary" >';
				         echo '</form>';
